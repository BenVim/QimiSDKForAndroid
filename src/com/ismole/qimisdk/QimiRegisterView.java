...
public class QimiRegisterView extends Activity {
    ...
    private EditText userPassVerify;
    private View mLoginStatusView;
    private View mLoginFormView;
    private String mEmail;
    private String mPassword;
    private String mPassVerify;
    ...
    private void init()
    {
        ...
        userPassVerify = (EditText)findViewById(R.id.passVerify);
    ...
    public void attemptLogin() {
        ...
        if (TextUtils.isEmpty(mPassword)) {
            ...
            focusView = userPass;
            cancel = true;
        } else if (TextUtils.isEmpty(mPassVerify))
        {
            userPassVerify.setError(getString(R.string.error_Verify_pass));
            focusView = userPassVerify;
            cancel = true;
        }else if (!mPassword.equals(mPassVerify))
        {
            userPass.setError(getString(R.string.error_diff_password));
            focusView = userPassVerify;
            cancel = true;
        }
    ...
    {
        //appid=%dbirthday=2000-10-10do=regemail=%smod=Username=%spassword=%ssex=1%s
        ...
        String sign ="appid="+m_appid+"birthday=2000-10-10do=regemail="+m_email+"mod=Username="+m_email+"password="+m_pass+"sex=1"+getString(R.string.sign);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try{
                ...
                mData.add(new BasicNameValuePair("do", "reg"));
                ...
                mData.add(new BasicNameValuePair("name",u));
                mData.add(new BasicNameValuePair("sex","1"));
                mData.add(new BasicNameValuePair("birthday","2000-10-10"));
            ...
            showProgress(false);
                try
                {
                    ...
                    if (s.equals("100"))
                    {
                        ...
                        Dialog alertDialog = new AlertDialog.Builder(QimiRegisterView.this).
                                setTitle(s).
                                setMessage(getString(R.string.register_sucssful)).
